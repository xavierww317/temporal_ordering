...
if __name__ == '__main__':
    f = open('./result/resnet50/result_{}.csv'.format(args.batchsize), 'w', encoding='utf-8')
        ...
        with torch.no_grad():
            for input, _ in iter(data_loader):
                ...
                if len(frame_list) == args.batchsize:
                    ...
                    frame_combination_new = function.frame_channel_combination(frame_combination).to(device)
